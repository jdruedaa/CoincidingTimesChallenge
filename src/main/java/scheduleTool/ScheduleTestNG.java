...
public class ScheduleTestNG {

    public String answer(String caseNamesAndAssistance) {
        ArrayList<ArrayList> namesAndAssistance = readData(caseNamesAndAssistance);
        Map<String, Integer> coincidedOfficeTimes = findCoincidedTimes(namesAndAssistance);
        return printCoincidedTimes(coincidedOfficeTimes);
    }

    public static ArrayList<ArrayList> readData(String caseNamesAndAssistance) {
        ArrayList<ArrayList> data = new ArrayList<>();
        String[] namesAndAssistance = caseNamesAndAssistance.split("\n");
        ...
        for(String line:namesAndAssistance)
        {
            nameAndAssistance = line.split("=");
    ...
    public String printCoincidedTimes(Map<String, Integer> coincidedTimes)
    {
        ...
        return formattedFinalAnswer.toString();
    }
}